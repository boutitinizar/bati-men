	...
	<header class="head" role="banner">
		...
		<div class="wrap clearfix">
			...
			<ul>
				...
				<li class="dark"><a href="<?php echo is_user_logged_in() ? esc_url ( $sc_theme_globals->get_submit_recipes_url() ) : esc_url ( $sc_theme_globals->get_login_page_url() ); ?>" title="<?php _e('Proposer une offre', 'socialchef'); ?>"><i class="ico i-submitrecipe"></i> <span><?php _e('propose une offre', 'socialchef'); ?></span></a></li>
